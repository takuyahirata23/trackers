defmodule Trackers.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Trackers.Repo)
  ...
  """
  def valid_password?(%Trackers.Accounts.User{hashed_password: hashed_password}, password)
